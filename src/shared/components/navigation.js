      ...
      <div className="nav_container">
        <div className="navigation">
          <ul>
            ...
            <li>
              <ActiveLink activeClassName="active" to="/products">
                <a>Produkter</a>
              </ActiveLink>
            </li>
            <li>
              <ActiveLink activeClassName="active" to="/faq">
                <a>Info</a>
              </ActiveLink>
            </li>
            <li>
              <ActiveLink activeClassName="active" to="/contact">
                <a>Kontakt oss</a>
              </ActiveLink>
            </li>
          </ul>
        ...
        <div className="logo_nav_container">
          <Image className="logo_nav" src={logo} height={50} width={200} to="/index" alt="logo" />
        </div>
